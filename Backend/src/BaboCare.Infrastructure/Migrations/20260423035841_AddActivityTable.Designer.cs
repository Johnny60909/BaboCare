...
namespace BaboCare.Infrastructure.Migrations
{
    ...
    [Migration("20260423035841_AddActivityTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Activities.Activity", b =>
                {
                    ...
                    b.ToTable("Activities", "public", t =>
                        {
                            t.HasComment("寶寶活動記錄表");
                        });
                });

            modelBuilder.Entity("BaboCare.Domain.Entities.Babies.Baby", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(26)")
                        .HasComment("主鍵 (ULID)");
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Babies.BabyParent", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(26)");
                    ...
                    b.HasIndex("BabyId", "ParentId")
                        .IsUnique()
                        .HasDatabaseName("IX_BabyParent_BabyId_ParentId");

                    b.ToTable("BabyParents", "public");
                });

            modelBuilder.Entity("BaboCare.Domain.Entities.PendingUsers.PendingUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Users.ApplicationRole", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)")
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Users.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(26)
                        .HasColumnType("character varying(26)")
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Activities.Activity", b =>
                {
                    b.HasOne("BaboCare.Domain.Entities.Babies.Baby", "Baby")
                        .WithMany()
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Babies.Baby", b =>
                {
                    b.HasOne("BaboCare.Domain.Entities.Users.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BaboCare.Domain.Entities.Babies.BabyParent", b =>
                {
                    ...
                    b.HasOne("BaboCare.Domain.Entities.Users.ApplicationUser", "Parent")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("BaboCare.Domain.Entities.Users.ApplicationRole", null)
                        .WithMany()
